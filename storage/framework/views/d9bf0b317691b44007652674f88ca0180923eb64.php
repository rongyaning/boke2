...
<html><!--<![endif]-->
    ...
    <!-- 全局顶部导航栏 -->
		...
		<!-- 左上方 Logo -->
			<a class="logo" href="http://www.jianshu.com/"><img src="<?php echo e(asset('homes/images/logo-58fd04f6f0de908401aa561cda6a0688.png')); ?>" alt="Logo"></a>
	...
	<div class="container setting">
		<div class="row">
			...
			<div class="col-xs-16 col-xs-offset-8 main">
				...
				<a href="<?php echo e(URL('home/personal/index')); ?>"<button type="submit" class="btn btn-success setting-save">保存</button></a>
