...
<html lang="zh-cn"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
		<title>
			...
			<script src="<?php echo e(asset('homes/js/jquery.js.下载')); ?>" type="text/javascript"></script>
            <script src="<?php echo e(asset('homes/js/json2.js.下载')); ?>" type="text/javascript"></script>      
            <script type="text/javascript" src="<?php echo e(asset('homes/js/jquery.cnblogs.thickbox.js.下载')); ?>"></script>
            <script type="text/javascript" src="<?php echo e(asset('homes/js/admin.js.下载')); ?>"></script>
	</head>	
	<body id="Articles">
...
<div class="aspNetHidden">
	...
	<input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="61AB59E7">
</div>
			<table id="BodyTable" border="0" cellpadding="0" cellspacing="0" width="100%">
				<tbody><tr>	<td id="Header" colspan="2"><div id="SiteNav"><a href="http://home.cnblogs.com/set/account/" target="_blank">修改密码</a>&nbsp;|&nbsp;<a href="https://i.cnblogs.com/BlogBackup.aspx">备份</a>&nbsp;|&nbsp;<a href="http://www.cnblogs.com/Skins.aspx" target="_blank">模板</a></div>
				...
				<tr>
					...
					<td class="NavHeaderRow">
						<ul id="TopNav">
							...
							<li>
								<a href="" id="TabArticles">文章</a>
							</li>
						
							<li>
								<a href="" id="TabFeedback">评论</a>
							</li>
				...
				<tr>
					<td class="NavLeftCell">						
						<div class="left_nav">
							<ul id="LinksActions"><li><a href="<?php echo e(url('home/detail/create')); ?>">» 添加新文章</a></li></ul>
    ...
    <div id="Editor_Messages">
        <div class="MessagePanel">
		    <img src="<?php echo e(asset('homes/images/ico_info.gif')); ?>"><div>
			    发布成功
		    </div>
	    </div>
    </div>
	<div id="TipsPanel" class="Edit">
        ...
        <p><a id="TipsPanel_LinkEdit" href="<?php echo e(url('home/detail')); ?>">» 继续编辑</a></p>
        <p><a href="<?php echo e(url('home/detail')); ?>">» 后台首页</a></p>
            ...
            <div id="blog_top_nav_block">
                ...
                <div id="login_area">          
                <span id="span_userinfo"><a id="lnkBlogUrl" href="http://home.cnblogs.com/u/ryn521/">花沐</a> · <a href="http://msg.cnblogs.com/" target="_blank" id="lnk_site_msg">短消息</a> · <a href="http://passport.cnblogs.com/logout.aspx?ReturnURL=http://www.cnblogs.com/ryn521/" onclick="return confirm(&#39;确认要退出登录吗?&#39;)">退出</a></span>
                </div>
                <div class="clear"></div> 
            </div>
