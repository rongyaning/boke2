...
<li><a id="blog_nav_myhome" class="menu" href="<?php echo e(url('home')); ?>">首页</a></li>
...
<textarea id="ds" name="content" class="comment_textarea"></textarea>
<textarea id="a" class="comment_textarea" readonly> 
