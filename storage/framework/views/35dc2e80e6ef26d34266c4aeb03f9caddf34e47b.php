...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <link href="<?php echo e(asset('css/signin_bundle.css')); ?>" type="text/css" rel="stylesheet">
            ...
            <div id="Main">
                <noscript>
                    ...
                    <form method="post" onsubmit="return false;">
                        ...
                        <div class="block">
                            <label class="label-line">登录用户名(<a href="https://passport.cnblogs.com/GetUsername.aspx" tabindex="-1" class="tb_right">找回</a>)</label>
                            <input type="text" id="input1" value="" class="input-text" onkeydown="check_enter(event)"> <span id="tip_input1" class="tip"></span>
                        </div>
                        <div class="block">
                            <label class="label-line">密码(<a href="https://passport.cnblogs.com/GetMyPassword.aspx" tabindex="-1" class="tb_right">重置</a>)</label>
                        ...
                        <div class="block nav">
                            » <a href="https://passport.cnblogs.com/register.aspx?ReturnUrl=https://www.cnblogs.com/" title="注册成为博客园用户">立即注册</a><br>
