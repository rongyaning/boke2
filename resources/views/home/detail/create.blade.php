...
<html lang="zh-cn"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
		<title>
			...
			<script src="{{asset('homes/js/jquery.js')}}" type="text/javascript"></script>
            <script src="{{asset('homes/js/json2.js')}}" type="text/javascript"></script>      
            <script type="text/javascript" src="{{asset('homes/js/jquery.cnblogs.thickbox.js')}}"></script>
<script type="text/javascript" src="{{asset('homes/js/admin.js')}}"></script>
	</head>	
	<body id="Articles">
...
<script language="JavaScript" src="{{asset('homes/js/uicontrols.js')}}"></script>-->
<div class="aspNetHidden">
	...
	<input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="0512620B">
			...
			<table id="BodyTable" border="0" cellpadding="0" cellspacing="0" width="100%">
				<tbody>
					<tr>
						<td id="Header" colspan="2"><div id="SiteNav"><a href="http://www.cnblogs.com/Skins.aspx" target="_blank">模板</a></div>
							<div id="BlogTitle">
						...
						<td id="Body">
							<div id="Main">
								...
								<div id="Editor_Edit_Contents">
									<div id="edit_container">
										...
										<div id="edit_title">
											<b>上传头像</b>            
											<br>
											<input name="Editor$Edit$txbTitle" type="file" maxlength="200" id="Editor_Edit_txbTitle" onblur="localPreserver.saveDraftTitle();" onkeydown="title_keydown(event);" style="width:99%;">
										</div>
										<div id="edit_body">
											...
											<img title="上传图片" onclick="markdown_image_upload(&#39;Editor_Edit_EditorBody&#39;);return false;" src="{{asset('homes/images/img.gif')}}" alt="上传图片">
								...
								<div class="post_block">
									<input type="submit" name="Editor$Edit$lkbPost" value="发布" id="Editor_Edit_lkbPost" class="Button">
									<input type="submit" name="Editor$Edit$lkbCancel" value="取消"  id="Editor_Edit_lkbCancel" class="Button">            
								</div>         
            ...
            <div id="blog_top_nav_block">
                ...
                <span id="span_userinfo">
					...
					· <a href="http://msg.cnblogs.com/" target="_blank" id="lnk_site_msg">短消息</a> · <a href="http://passport.cnblogs.com/logout.aspx?ReturnURL=http://www.cnblogs.com/fnxz/" onclick="return confirm(&#39;确认要退出登录吗?&#39;)">退出</a></span>
                </div>
                <div class="clear"></div> 
            </div>
