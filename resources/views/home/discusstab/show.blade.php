...
<form action="{{url('home/discusstab')}}" method="post" id="dd" >
...
<p>
昵称：<input type="text" id="tbCommentAuthor" class="author" disabled="disabled" size="50" value="{{session('User')}} ">
</p>
...
<h3 class="catListTitle">公告</h3>
	<div id="blog-news"></a><div id="profile_block">昵称：{{session('User')}}<br></div></div>
</div>
